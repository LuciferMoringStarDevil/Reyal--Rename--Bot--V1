...
help_keyboard = [[InlineKeyboardButton('⚒️Support Channel⚒️', url='https://t.me/ONLY_CODES'),
                    InlineKeyboardButton('🌟Feedback🌟', url='https://t.me/Lucifer_Devil_AD')
                ],
                [
                    InlineKeyboardButton('🤩Other Bots🤩', url='https://t.me/AD_BOTZ'),
                    InlineKeyboardButton('💠Source💠', url='https://github.com/LuciferMoringStarDevil/Reyal--Rename--Bot--V1')]]
